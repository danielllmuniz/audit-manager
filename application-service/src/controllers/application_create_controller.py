...
class ApplicationCreatorController:
    ...
    def __insert_person_in_db(self, name: str, owner_team: str, repo_url: str) -> Dict:
        application_data = {
            "name": name,
            "owner_team": owner_team,
            "repo_url": repo_url
        }
        application_created = self.__application_repository.create(application_data)
        return application_created

    def __format_response(self, application_created: Dict) -> Dict:
        response = {
            "data" : {
                    "application_id": application_created["application_id"],
